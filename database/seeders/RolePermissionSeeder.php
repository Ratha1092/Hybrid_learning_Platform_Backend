...
class RolePermissionSeeder extends Seeder
{
    private const MODULES = [
        ...
        'reports'    => ['export', 'view_executive', 'view_revenue', 'view_payment', 'view_payout','view_course_intelligence', 'view_instructor_intelligence','view_learning_intelligence', 'view_audit', 'schedule'],
    ...
    private const ROLE_PERMISSIONS = [
        'admin' => ['users.*', 'courses.*', 'orders.*', 'coupons.*', 'analytics.view', 'reviews.*', 'settings.*','reports.export', 'reports.view_executive', 'reports.view_revenue', 'reports.view_payment',    'reports.view_payout', 'reports.view_course_intelligence', 'reports.view_instructor_intelligence','reports.view_learning_intelligence', 'reports.schedule','system.view_security',],
        'finance-manager' => ['payments.*', 'wallets.*', 'payouts.*', 'coupons.*', 'analytics.view', 'reports.export','reports.view_revenue', 'reports.view_payment', 'reports.view_payout', 'reports.schedule', 'settings_finance.*',],
        'accountant' => ['payments.view', 'wallets.view', 'payouts.view', 'reports.export','reports.view_revenue', 'reports.view_payment', 'reports.view_payout',],
