...
class RolePermissionSeeder extends Seeder
{
    ...
    private const ROLE_PERMISSIONS = [
        ...
        'finance-manager' => ['payments.*', 'invoices.*', 'receipts.*', 'wallets.*', 'payouts.*', 'coupons.*', 'analytics.view', 'reports.export','reports.view_revenue', 'reports.view_payment', 'reports.view_payout', 'reports.schedule', 'settings_finance.*',],
        'accountant' => ['payments.view', 'invoices.view', 'invoices.download', 'receipts.view', 'receipts.download', 'wallets.view', 'payouts.view', 'reports.export','reports.view_revenue', 'reports.view_payment', 'reports.view_payout',],
