...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p>If you have questions, you can reach our support team at <a href="mailto:{{ \App\Domains\System\Models\Setting::get('support_email', config('mail.from.address')) }}">{{ \App\Domains\System\Models\Setting::get('support_email', config('mail.from.address')) }}</a>.</p>
        <p>Thank you for choosing {{ \App\Domains\System\Models\Setting::get('site_name', config('app.name')) }}.</p>
    </div>
    <div class="footer">
