...
<head>
    ...
    <style>
        ...
        .header { background: #16a34a; color: #fff; text-align: center; padding: 20px; border-radius: 8px 8px 0 0; margin: -40px -40px 30px; }
        .badge { display: inline-block; background: #dcfce7; color: #16a34a; padding: 6px 16px; border-radius: 20px; font-weight: bold; }
