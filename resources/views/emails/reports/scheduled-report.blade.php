...
<head>
    ...
    <style>
        ...
        .header { background: #D7A441; color: #fff; text-align: center; padding: 20px; border-radius: 8px 8px 0 0; margin: -40px -40px 30px; }
        .badge { display: inline-block; background: #fdf3e0; color: #8a6315; padding: 6px 16px; border-radius: 20px; font-weight: bold; }
