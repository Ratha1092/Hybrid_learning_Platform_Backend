...
.bi-kpi-grow.up { color: var(--ok); }
.bi-kpi-grow.dn { color: var(--err); }
.bi-kpi-grow.neu { color: var(--t2); }
...
@media (max-width: 820px) {
    .bi-charts-2 { grid-template-columns: 1fr; }
    .bi-grid-2 { grid-template-columns: 1fr; }
}

@media (max-width: 700px) {
    .bi-charts-3 { grid-template-columns: 1fr; }
