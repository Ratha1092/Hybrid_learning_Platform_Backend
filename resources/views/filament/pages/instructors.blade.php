...
.lp-instructor-cell { display:flex; align-items:center; gap:10px; }
.lp-avatar { width:32px; height:32px; border-radius:50%; object-fit:cover; flex-shrink:0; }
.lp-instructor-name { font-size:13px; font-weight:650; color:var(--t1); }
        ...
        <div class="lp-toolbar">
            ...
            <form method="GET" action="{{ url()->current() }}" style="display:flex;align-items:center;gap:0">
                ...
                <div class="lp-search-box">
                    ...
                    <input type="text" name="search" value="{{ $search }}" placeholder="Filter instructors...">
                </div>
            </form>
        </div>
