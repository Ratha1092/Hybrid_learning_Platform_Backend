...
.mda {
    opacity:0;
    animation:mdUp .45s cubic-bezier(.16,1,.3,1) forwards;
}
.md1 {
    animation-delay:.04s;
}
...
.md-filter:focus-within .md-filter-chevron {
...
.md-filter:focus-within .md-filter-menu {
    display:block;
}
.md-filter-item {
    display:flex;
...
.md-filter-item:hover {
    background:var(--p2);
}
.md-filter-item.active {
    background:var(--p2);
}
.md-filter-item-label {
    flex:1 1 auto;
}
...
.md-page-btn:not(.disabled):hover {
    background:var(--p2);
