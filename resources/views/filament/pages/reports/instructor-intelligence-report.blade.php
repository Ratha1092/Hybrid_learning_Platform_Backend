@php
    $presets = \App\Filament\Pages\Reports\InstructorIntelligenceReport::dateRangePresetOptions();
@endphp
...
<div class="rp">
    <div class="rp-header">
        ...
        <div class="rp-actions">
            <a href="{{ route('admin.reports.csv', ['type' => 'instructor_intelligence'] + request()->query()) }}" class="rp-btn">Export CSV</a>
            <a href="{{ route('admin.reports.pdf', ['type' => 'instructor_intelligence'] + request()->query()) }}" class="rp-btn">Export PDF</a>
    ...
    <div class="rp-kpi-grid">
        <div class="rp-kpi-card"><div class="rp-kpi-label">Active Instructors</div><div class="rp-kpi-value">{{ number_format($kpis['totalInstructors']) }}</div></div>
