...
.sta {
    opacity:0;
    animation:stUp .4s cubic-bezier(.16,1,.3,1) forwards;
}
.st1 {
    animation-delay:.04s;
}
...
.st-input-wrap:has(.st-input-suffix) .st-input {
...
.st-switch input:checked + .st-switch-track::before {
...
.st-gateway-card:has(input:checked) {
    border-color:var(--accent);
}
.st-gateway-info {
    display:flex;
