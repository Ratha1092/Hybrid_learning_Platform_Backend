...
.rfv-field-value.muted {
    color:var(--t2);
    font-weight:500;
    font-style:italic;
}

.rfv-customer-profile {
    display:flex;
    flex-direction:column;
    align-items:center;
    text-align:center;
...
.rfva {
    opacity:0;
    animation:rfvUp .4s cubic-bezier(.16,1,.3,1) forwards;
}
.rfv1 {
    animation-delay:.05s;
}
