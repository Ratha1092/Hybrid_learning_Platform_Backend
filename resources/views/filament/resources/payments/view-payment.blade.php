...
.ov-stat-row{display:grid;gap:12px;padding-bottom:18px;margin-bottom:18px;border-bottom:1px solid var(--bd)}
.ov-stat-label{font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--t2);margin-bottom:5px}
.ov-mini-badge{display:inline-flex;align-items:center;padding:3px 9px;border-radius:6px;font-size:11.5px;font-weight:700}

/* Big amount */
.ov-big-amount{font-size:36px;font-weight:800;letter-spacing:-.03em;color:#059669;line-height:1}
...
/* Order card */
.ov-order-number{font-family:ui-monospace,SFMono-Regular,monospace;font-size:14px;font-weight:700;color:var(--accent)}
.ov-meta-grid{display:grid;grid-template-columns:1fr 1fr;gap:0;width:100%}
...
.ov-customer-row{display:flex;align-items:center;gap:10px;padding:14px 0;border-bottom:1px solid var(--bd);margin-bottom:14px}
.ov-avatar{width:44px;height:44px;border-radius:50%;object-fit:cover;border:2px solid var(--bd2);flex-shrink:0}
.ov-customer-name{font-size:14px;font-weight:700;color:var(--t1)}
.ov-customer-email{font-size:12px;color:var(--t2);margin-top:2px}

/* References table */
.ov-table{width:100%;border-collapse:collapse}
.ov-table th{font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--t2);padding:8px 16px;text-align:left;border-bottom:1px solid var(--bd);background:var(--p2)}
.ov-table td{padding:14px 16px;border-bottom:1px solid var(--bd);vertical-align:middle}
.ov-table tr:last-child td{border-bottom:none}
.ov-ref-label{font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:var(--t2);margin-bottom:4px}
.ov-ref-value{font-family:ui-monospace,SFMono-Regular,monospace;font-size:12px;color:var(--t1);word-break:break-all}
.ov-copy-btn{background:none;border:none;cursor:pointer;color:var(--t2);padding:3px;border-radius:4px;display:inline-flex;align-items:center;transition:color .15s;vertical-align:middle;margin-left:4px}
.ov-copy-btn:hover{color:var(--t1)}
.ov-copy-btn svg{width:13px;height:13px}

/* JSON block */
.ov-json-block{background:var(--p2);border:1px solid var(--bd);border-radius:8px;padding:14px 16px;font-family:ui-monospace,SFMono-Regular,monospace;font-size:11.5px;color:var(--t2);white-space:pre-wrap;word-break:break-all;max-height:280px;overflow-y:auto;line-height:1.6}

/* Verification stats */
.ov-verify-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}

/* Transactions table */
.ov-txn-badge{display:inline-flex;align-items:center;padding:3px 9px;border-radius:6px;font-size:11px;font-weight:700}
...
.ov1{animation-delay:.05s}.ov2{animation-delay:.1s}.ov3{animation-delay:.15s}.ov4{animation-delay:.2s}.ov5{animation-delay:.25s}
</style>
