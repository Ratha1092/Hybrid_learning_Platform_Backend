...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .receipt-title { font-size: 13px; font-weight: bold; color: #D7A441; text-transform: uppercase; letter-spacing: 1px; }
        .receipt-number { font-size: 11px; color: #6b7280; margin-top: 4px; }
        ...
        .item-instructor { color: #6b7280; font-size: 10.5px; margin-top: 2px; }
        ...
        .totals-row.grand .totals-value { color: #15110a; font-weight: bold; font-size: 15px; }
...
<body>
    ...
    <div class="footer">
        Thank you for your purchase on {{ $siteName }}.<br>
